  ...
  return (
    <div className="max-w-6xl mx-auto space-y-8">
      <div className="flex items-center space-x-4">
        <Link href={`/learning-path/${module.learningPathId}`} className="p-2 hover:bg-gray-100 rounded-full transition-colors">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 space-y-8">
          <div className="prose prose-blue max-w-none bg-white p-8 rounded-xl border shadow-sm">
            ...
            <ul className="grid grid-cols-1 md:grid-cols-2 gap-4 list-none p-0">
              {content.keyConcepts.map((concept: string, i: number) => (
                <li key={i} className="bg-blue-50 text-blue-700 px-4 py-3 rounded-lg text-sm font-medium flex items-center">
            ...
            <h3 className="flex items-center text-xl font-bold text-gray-900 mt-10 mb-4">
              <GraduationCap className="mr-2 h-5 w-5 text-green-600" />
              Pratik Uygulama / Proje Fikri
            </h3>
            <div className="bg-green-50 border-l-4 border-green-500 p-6 rounded-r-lg italic text-gray-700">
              {content.projectIdea}
            </div>
